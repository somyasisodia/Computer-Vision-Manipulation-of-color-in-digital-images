...
for i in range(H1, H2) :
	for j in range(W1, W2) :
		...
		val=1
		for Lvalues in hist_dict.items():
			if(Lvalues[0] == L_dash):
				val=Lvalues[1]+1
					
		new_dict={L_dash: val}	
		#print("new_dict : "+new_dict[0])
		hist_dict.update(new_dict)
		
		#if (L<0 or L>100):
		#	print("Incorrect L : "+str(L))
...
for k, v in hist_dict.items():
	f_dash[k]=math.floor(((f[j]+f[k])/2)*(101/sum))
	j=k
...
#print("Lmax : "+str(Lmax)+" Lmin : "+str(Lmin))	
